...
export const postInfoSlice = createSlice({
  ...
  initialState,
  reducers: {
    PostComponentToStore: (
      state: postContentParamType,
      action: PayloadAction<string>
    ) => {
      console.log("action.payload:", action.payload);
      state.postContent = action.payload;
    },
    CommentsLengthComponentToStore: (
      state: commentAndPostType,
      action: PayloadAction<{ roomId: string; commentLength: number }>
    ) => {
...
export const { PostComponentToStore, CommentsLengthComponentToStore } =
