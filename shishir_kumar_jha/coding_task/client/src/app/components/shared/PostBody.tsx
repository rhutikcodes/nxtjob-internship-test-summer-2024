...
export default function PostBody() {
  ...
  return (
    <div>
       { showcreatePostComponent?(<main className='blur-md bg-[#ffffff]  w-[880px] h-[1410px] top-[65px] absolute left-[430px] px-8 gap-6'>
            {/* frame 1 */}
            ...
            <div className='w-[816px] h-[160px] border-b-[1px] gap-2'>
                ...
                <div className='size-2xl  w-[64px] h-[64px] rounded-full bg-[#EBEBEF]'>
                    ...
                    <div className='h-[40px] w-[40px] top-[12px] left-[12px]'>
                        <Image className=' absolute top-[42.95px] left-[50.95px]' width={24.17} height={24.17}  src={"/cir.svg"} alt="circle" />
                        {/* Notification */}
        ...
        <p className='w-[816px] h-[32px] text-3xl mt-2 font-bold text-[#3F3F50] leading-8 size-[30px] '>Welcome to NxtJob</p>
        <p className='w-[816px] h-[48px] text-base mt-2 leading-6 font-normal size-[16px] text-[#8A8AA3]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
            </div>
      {/* sub frame 4809... */}
    ...
    {/* actual input */}
    <input onClick={PostToogle} placeholder='Start a post'  className='w-[752px]  flex items-center h-[48px] rounded-3xl px-5 bg-[#f7f7f8] border-[1px] border-[#d1d1db]'/>
